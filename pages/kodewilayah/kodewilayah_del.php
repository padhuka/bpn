<?php
    ...
    $id = $_GET['id'];
    $sqlemp = "SELECT * FROM m_kodewilayah WHERE id='$id'";
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Hapus Data Kode Wilayah</h4>                        
                    </div>
                ...
                <script type="text/javascript">
                  $(document).ready(function (){
                        $(".save_submit").click(function (e){
                            var id = $('#id').val();
                           $.ajax({
                                url: 'kodewilayah/kodewilayah_del_save.php?id='+id,
                                type: 'GET',
