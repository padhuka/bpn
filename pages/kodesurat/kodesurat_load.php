			...
			<table id="example1" class="table table-bordered table-striped">
                ...
                <?php
                                    $j=1;
                                    $sqlcatat = "SELECT * FROM m_kodesurat ORDER BY id ASC";
              ...
              <script>
  			    ...
  			    $(".open_add").click(function (e){
  					                    //var m = $(this).attr("id");
  					        $.ajax({
  					        url: "kodesurat/kodesurat_add.php",
  					        type: "GET",
            ...
            //$(".open_del").click(function (e){
             function open_del(){
                                $.ajax({
                                    url: "kodesurat/kodesurat_del.php?id="+iddel,
                                    type: "GET",
                                    //data : {id: m,},
                                    success: function (ajaxData){
           ...
           function open_modal(){
                ...
                //var m = $(this).attr("id");    
                              ...
                              $.ajax({
                                  url: "kodesurat/kodesurat_edit.php?id="+idedit,
                                  type: "GET",
                                  //data : {id: m,},
                                  success: function (ajaxData){
