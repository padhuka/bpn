<?php
        ...
        $photo3 = $_POST['filescanhid3'];
		 ...
		 #cek idsurat
        $sqlcek = "SELECT * FROM t_arsip WHERE nomorhak='$noagenda'";
        ...
        if ($row){
        	...
        	if(!empty($_FILES['filescan']['name'])){
		        ...
		        $sqltbemp = "INSERT INTO t_arsip (nomorhak,jenishak,kabupaten,kecamatan,kelurahan,bukutanah,suratukur,warkah) VALUES ('$nomorhak','$jenishak','$kabupaten','$kecamatan','$kelurahan','$photo','$photo2','$photo3')";
