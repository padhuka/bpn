    ...
    <section class="content-header">
      <h1>
        ...
        <small>
              ...
              <span id="ekspor" onclick="ekspor();" style="cursor: pointer;">&nbsp;&nbsp;[ Ekspor Laporan ]</span>

        <!--<form enctype="multipart/form-data" novalidate id="fupForm">
              ...
              <span id="ekspor" onclick="ekspor();" style="cursor: <input type="button" name="cari" id="cari" value="Cari" onclick="findsurat();">pointer;">                                
                               &nbsp;&nbsp;[ Ekspor Laporan ]
                            </span>
          </form>--></small>
      </h1>
    ...
    <!-- /.content -->
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function (){
                  $("#tabele").load('laporan/laparsip_load.php');  
                  ...
                  document.getElementById("cari").addEventListener("click", 
                      function () {
                          var tgl= $('#tgl').val();
                          var tgl2= $('#tgl2').val();
                          $("#tabele").load('laporan/laparsip_load.php?tgl='+tgl+'&tgl2='+tgl2);
