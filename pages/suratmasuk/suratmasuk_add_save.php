<?php
        ...
        if ($row){
        	...
        	if(!empty($_FILES['filescan']['name'])){
		        ...
		        $sqltbemp = "INSERT INTO t_surat_masuk (no_agenda,dari,isi_ringkas,no_surat,tgl_surat,tgl_diterima,file,tahun,agenda_pdf,dibales) VALUES ('$noagenda','$asalsurat','$perihal','$nosurat','$tglsurat','$tglterima','$photo','$tahunnow','1','$dibales')";
