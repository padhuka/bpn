                        ...
                        <h4 class="modal-title" id="myModalLabel" style="text-align: center;padding-right: 0px;line-height:1">Tambah Data Surat Masuk</h4>                        
				          ...
				          <div class="box box-info" style="border-top-color:#dd4b39">
				            <!--<div class="box-header with-border">
				             ...
				             /.box-header -->
				            <!-- form start -->
				            <form class="form-horizontal" enctype="multipart/form-data" id="fupForm">
								...
								<div class="form-group" style="margin-bottom:1px">
                                  ...
                                  ?>
                                  <input type="checkbox" id="cbocust[]" name="cbocust[]" class="cbocustz" value="<?php echo $catat['nip'];?>" />&nbsp;<?php echo $catat['nama'];?><br/>
                                  <?php }?>
				                  </div>
				                </div>
				                		</td>
				               ...
				               <tr>
				                ...
				                <div class="form-group" style="margin-bottom:1px">
				                  ...
				                  <div class="col-sm-6">
				                  	...
				                  	<input type="hidden" id="disposisi"  name="disposisi" value="123">
	    ...
	    /// Set check or unchecked all checkboxes
                      ...
                      $("#fupForm").on('submit', function(e){
                          ...
                          var cbocustb = [];
                            ...
                            $('.cbocustz:checked').each(function(){
                                    
                                    cbocustb.push($(this).val());              
                                    });
                            //alert(cbocustb);
                          	///return false;
                            var disposisine = cbocustb.toString();                            
