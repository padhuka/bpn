<!-- general form elements disabled -->
   <?php
    ...
    $id = $_GET['id'];
    $sqlemp = "SELECT * FROM t_surat_keluar WHERE id='$id'";
			...
			<div class="col-md-11">
                <div class="modal-content" style="border-radius:10px">
                    <div class="modal-header" style="padding: 8px;border-top-style: 5px">
                        ...
                        <h4 class="modal-title" id="myModalLabel" style="text-align: center;padding-right: 0px">Edit Data Surat Keluar #<?php echo $agen;?></h4>                   
                    </div>
				          ...
				          <div class="box box-info" style="border-top-color:#dd4b39">
				                ...
				                <div class="form-group" style="margin-bottom:1px;">
				                  ...
				                  <div class="col-sm-4">
				                    <input type="text" class="form-control" id="noagenda" name="noagenda" required value="<?php echo substr($emp['no_surat'],-4).'.'.$emp['kode'];?>" readonly>
				                		...
				                		<td>
				                		<div class="col-sm-4">
				                    <input type="hidden" class="form-control" id="agenda" name="agenda" required value="<?php echo $agen;?>">
				                  	</div>
				              		</td>
				                	...
				                	<tr>
				              		<td style="padding: 8px;padding-right: 2px">			               
				              		 <div class="form-group"  style="margin-bottom:1px;padding-right: 0px;padding-right: 0px">
				               		   <label for="inputEmail3" class="col-sm-4 control-label" style="text-align: left;padding-right: 0px;padding-right: 0px">Kode Surat</label>

				                 		 <div class="col-sm-6" style="padding-right: 0px;padding-left: 15px;width: 300px"">
				                 	
				                	 <div class="col-sm-2" style="padding-right: 0px;padding-left: 0px;width: 70px">

				                    <input type="text" class="form-control" id="kodesurat" name="kodesurat" required style="padding-right: 0px;padding-left: 0px" value="<?php echo $kk;?>">
				                  	</div>
				                  ...
				                  <div class="col-sm-2" style="padding-right: 0px;padding-left: 0px;padding-right: 0px;padding-left: 0px;height: 34px;width: 40px;">
				                    <input type="text" class="form-control" id="wilayah" name="wilayah" style="padding-right: 0px;padding-left: 0px" required value="92.02">
				                  </div>
				                    <div class="col-sm-2" style="
									  	  padding-top: 10px;
									    padding-right: 10px;
				            ...
				            <td>
								...
								<tr>
				                  ...
				                  <div class="col-sm-4">
				                    <input type="text" class="form-control" onclick="suratmasuke();" id="suratmasuks" name="suratmasuks" value="<?php echo $emp['suratmasuk'];?>" readonly >
				                    <input type="hidden" class="form-control" id="suratmasuks2" name="suratmasuks2" value="<?php echo $emp['suratmasuk'];?>" readonly >
				                  </div>
				              ...
				              <table class="table" style="font-size: 12px;">
				              	<tr>
				              		<td>
				              			  <div class="form-group" style="margin-bottom:1px">
				                  <label for="inputEmail3" class="col-sm-4 control-label" style="text-align: left;">Tgl surat</label>
...
">
					                <div class="input-group date">
					                  ...
					                  <input type="text" class="form-control pull-right" id="tglsurat" name="tglsurat" required value="<?php echo $emp['tgl_surat'];?>" onchange="tgle();">
					                </div>
				                  </div>
				                </div>
				              		</td>
				              	...
				              	<tr>
				              		<td>
				              			  <div class="form-group" style="margin-bottom:1px">
				                  <label for="inputEmail3" class="col-sm-4 control-label" style="text-align: left;">Tujuan</label>
				                  <div class="col-sm-8" style="
    padding-left: 0px;
">
				                    <?php 
				                    $kode=trim($emp['tujuan']);
				                    $sqlcatat2 = "SELECT * FROM m_tujuan WHERE kode='$kode'";
				                    $tuj=mysql_fetch_array(mysql_query($sqlcatat2));
				                    ?>
				                    <input type="text" class="form-control pull-right" id="tujuan" name="tujuan" required value="<?php echo $tuj['nama'].' - '.$emp['tujuan'];?>" onclick="tujuane();" readonly>
				                  </div>
				                </div>
				              		</td>
				              		<td>
				              	...
				              	<tr>
				              		<td>
				              			  <div class="form-group" style="margin-bottom:1px">
				                  <label for="inputEmail3" class="col-sm-4 control-label" style="text-align: left;">Perihal</label>
				                  <div class="col-sm-8" style="
    padding-left: 0px;
">
				              	...
				              	<tr>
				              		<td>
				              			  <div class="form-group" style="margin-bottom:1px">
				                  <label for="inputEmail3" class="col-sm-4 control-label" style="text-align: left;">File Lama</label>
				                  <div class="col-sm-8" style="
    padding-left: 0px;
">
				                ...
				                <div class="form-group">
				                  <label for="inputEmail3" class="col-sm-4 control-label" style="text-align: left;">File Scan</label>
				                  <div class="col-sm-8" style="
    padding-left: 0px;
">
	    			...
	    			document.getElementById("filescan").addEventListener("change", 
                      ...
                      $("#fupForm").on('submit', function(e){
                          e.preventDefault();
                           						...
                           						$.ajax({
                                                  type: 'POST',
                                                  url: 'suratkeluar/suratkeluar_edit_save.php',
