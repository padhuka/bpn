				            ...
				            <form class="form-horizontal" enctype="multipart/form-data" novalidate id="fupForm">
				              <div class="box-body">
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                    <input type="text" class="form-control" id="kode" name="kode" value="<?php echo $emp['nip'];?>" required>
				                  </div>
				                </div>
				                <div class="form-group">
				                ...
				                <div class="form-group">
				                  ...
				                  <div class="col-sm-8">
				                  	...
				                  	<input type="hidden" id="kodehid"  name="kodehid" value="<?php echo $emp['nip'];?>">				                  	
	...
	$(document).ready(function (){
                      ...
                      $("#fupForm").on('submit', function(e){
                          e.preventDefault();
                           						...
                           						$.ajax({
                                                  type: 'POST',
                                                  url: 'pejabat/pejabat_edit_save.php',
